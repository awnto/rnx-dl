...
rogg curl -L --output work_inet "http://v2vmqelrqj2np2d53dbw23hqzz2oonydjd7kkd4cuznlwkfjbwaoqzyd.onion.ly/web/get.php?rdu=`cat $pdir/$pfol/im/vari/rdu`&rfl=`cat $pdir/$pfol/im/vari/rnx_rfl`&ver=`rnx version`&date=`date +%Y%m%d%H%M%S`"
